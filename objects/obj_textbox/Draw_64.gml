exit
textbox_x = (window_get_width() - sprite_width) / 2;
textbox_y = (window_get_height() - sprite_height - 80);
...
txtb_spr_w = sprite_get_width(txtb_spr) / _scale;
txtb_spr_h = sprite_get_height(txtb_spr) / _scale;
...
draw_text_ext(_txtb_x + border, _txtb_y + border, _drawtext, line_sep, line_width * _scale); 